...
export function YdelseCta({ price }: { price?: string }) {
  return (
    <div className="bg-beige px-6 py-10 text-center md:px-16 md:py-[120px]" data-reveal>
      <h2 className="m-0 mb-3 font-serif text-[32px] font-normal leading-[1.3] md:mb-5 md:text-[44px]">
        Har du et projekt, jeg kan hjælpe dig med?
      </h2>
      {price && (
        <p className="m-0 mb-5 font-serif text-[20px] italic text-body md:mb-9 md:text-[22px]">
          {price}
        </p>
      )}
      <Link
